 ...
 ******************************************************************************
 ...
 Release Date: 2017-06-27 19:05:53
 *****************************************************************************/
...
#ifndef FREQ_2_4G
  #define MAC_MAX_FRAME_SIZE        2047   /* Maximum application data length without security */
#else
  #define MAC_MAX_FRAME_SIZE        127   /* Maximum application data length without security */
#endif
#endif
...
//#ifdef FREQ_2_4G
//#define MAC_CHAN_LOWEST             11
//#define MAC_CHAN_HIGHEST            26
//#endif
...
#define MAC_GENERIC_PHY_DESCRIPTOR_ENTRIES   6
...
typedef struct
{
  ...
  uint8 symbolRate;                   /* Symbol rate selection */
